...
Suite *list_push(void)
{
    ...
    tcase_add_test(tc_pos, push_pos_1);
    tcase_add_test(tc_pos, push_pos_2);

    suite_add_tcase(s, tc_pos);

    tc_neg = tcase_create("negatives");

    tcase_add_test(tc_neg, push_neg_1);
    tcase_add_test(tc_neg, push_neg_2);
